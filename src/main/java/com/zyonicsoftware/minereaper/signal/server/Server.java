...
public class Server extends Connection {
    ...
    public void connect() throws IOException {
        ...
        this.serverSocketAcceptingThread = new ServerSocketAcceptingThread("ServerSocketAcceptingThread", TimeUnit.MILLISECONDS, 1, this.serverSocket, this.scheduleDelay);
        RedEugeneScheduler.getRedEugeneIntroduction().scheduleWithoutDelay(this.serverSocketAcceptingThread);
    }
