...
<h2>A library for java with the native java socket technology and in combination with the custom bytebuffer allocator technology by boonproject</h2>
  <hr />
  <a href="https://gitlab.zyonicsoftware.com/mint9976/Signal/-/packages"><img src="https://img.shields.io/badge/release-v1.0.3-9cf" /></a>
...
````xml
compile group:'com.zyonicsoftware.minereaper.signal',name:'Signal',version:'v1.0.3'
````
...
````xml
mvn dependency:get -Dartifact=com.zyonicsoftware.minereaper.signal:Signal:v1.0.3
````
